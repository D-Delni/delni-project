...
const ScrollButton = ({ targetSectionId, className }) => {
  return (
    <Link
      ...
      className={`relative inset-0 flex justify-center items-center h-[120px] bg-custom-orange-default text-gray-800 text-lg font-bold ${className}`} // Full-size button
      >
      Scroll Down
    </Link>
  );
